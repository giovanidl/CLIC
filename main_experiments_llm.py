...
if __name__ == "__main__":
    ...
    train_dataset = PTBXLDatasetWithTextEmbeddingNPY(
        ...
        text_embedding_path="/home/giovanidl/doutorado/prelim/cache/npy_cache/llm_text_embeddings_train.npy",
        split="train",
        sampling_rate=500
    )
    val_dataset = PTBXLDatasetWithTextEmbeddingNPY(
        data_dir="/home/giovanidl/Datasets/PTBXL",
        text_embedding_path="/home/giovanidl/doutorado/prelim/cache/npy_cache/llm_text_embeddings_val.npy",
        split="val",
        sampling_rate=500
    )
    ...
    test_dataset = PTBXLDatasetWithTextEmbeddingNPY(
        data_dir="/home/giovanidl/Datasets/PTBXL",
        text_embedding_path="/home/giovanidl/doutorado/prelim/cache/npy_cache/llm_text_embeddings_test.npy",
        split="test",
        sampling_rate=500
    )
    ...
    for run in range(N_RUNS):
        ...
        metrics_df = train_loop(
            ...
            epochs=1000,
            save_path='/home/giovanidl/doutorado/prelim/checkpoints/ecgllm/',
            patience=50,
            monitor="val_loss",
            mode="min"
        )
        print(metrics_df)
        metrics_df.to_csv(f"/home/giovanidl/doutorado/prelim/checkpoints/ecgllm/metrics_run_{run+1}_MLP512_256.csv", index=False)
    ...
    # mean_report.to_csv("results/ECGLLM/ECGLLM_512_256_64mlp_5_1000_mean.csv")
    # std_report.to_csv("results/ECGLLM/ECGLLM_512_256_64mlp_5_1000_std.csv")
    # print("\n=====MEDIA =====")
    # print(mean_report)
    # print("\n=====STD =====")
    # print(std_report)
