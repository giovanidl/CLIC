...
if __name__ == "__main__":
    ...
    for run in range(N_RUNS):
        ...
        model = MODEL_RobustText(embedding_dim=512, mlp_hidden=512)
        ...
        metrics_df = train_loop(
            ...
            epochs=1000,
            save_path='/home/giovanidl/doutorado/prelim/checkpoints/ecgtext/',
            patience=50,
            monitor="val_loss",
            mode="min"
        )
        print(metrics_df)
        metrics_df.to_csv(f"/home/giovanidl/doutorado/prelim/checkpoints/ecgtext/metrics_run_{run+1}_MLP512_256.csv", index=False)
    ...
    # mean_report.to_csv("results/ECGText/ECGText_512_256_64mlp_5_1000_mean.csv")
    # std_report.to_csv("results/ECGText/ECGText_512_256_64mlp_5_1000_std.csv")
    # print("\n=====MEDIA =====")
    # print(mean_report)
    # print("\n=====STD =====")
    # print(std_report)
